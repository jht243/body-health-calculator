...
- **Deletion / questions:** Email **support@layer3labs.io** with the timestamp (UTC) of your ChatGPT session and we will delete the associated log entry within 7 days.
